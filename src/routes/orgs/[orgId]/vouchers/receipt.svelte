<script lang="ts">
	...
	const voucherTitle = 'Receipt'
    const debitTitle = 'Received in A/c'
    const creditTitle = 'Received from A/c'
    const creditMainNodes = [28]
    const debitMainNodes = [21, 18, 23]
